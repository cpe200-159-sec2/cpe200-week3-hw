...
public class Course {
    ...
    public String toString() {
        String numstu;
        if(this.no_students == 0) numstu = "NO student";
        else if(this.no_students == 1) numstu = "ONE student";
        else numstu = String.valueOf(this.no_students) + " students";
        String o = this.course_name + " ("
                + this.course_id + "), Teacher: "
                + this.lecturer + ", has "
                + numstu
                + ", [maximum: " + String.valueOf(this.max_students) + "]";
        return o;
    }
